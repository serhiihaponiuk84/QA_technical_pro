...
1. Створіть свій власний репозиторій.
2. В ньому створіть гілку js_homework1. Кожна наступна домашня робота буде здійснюватись в окремій гілці.
3. Вам необхідно вказати, яким буде результат операції та описати крок за кроком у вигляді коментарів,
